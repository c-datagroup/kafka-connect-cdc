...
import com.github.jcustenborder.kafka.connect.cdc.logminer.lib.utils.ErrorCode;
...
public enum JdbcErrors implements ErrorCode {
    ...
    JDBC_55("The default value of '{}' must be in the format '" + DateTimeFormat.DATE_FORMAT + "': {}"),
    JDBC_56("The default value of '{}' must be in the format '" + DateTimeFormat.DATETIME_FORMAT + "': {}"),
